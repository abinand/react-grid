...
var KEYS_Ord = exports.KEYS_Ord = {
    "asc": 0,
    "desc": 1
};

var REF_priority = exports.REF_priority = {
    "1": "#f0b27a", // orange
    "2": "#7dcea0", // green
    "3": "#7fb3d5", // blue
    "4": "#bb8fce" // purple
...
var REF_sortConfig = exports.REF_sortConfig = [{
    id: 1,
    display: "Featured",
    field: null,
    order: null
...
var objComparer = exports.objComparer = function objComparer(key) {
...
var _person = __webpack_require__(38);
...
var _dataApi = __webpack_require__(47);
    ...
    _createClass(App, [{
        ...
        value: function sortData(event) {
            var _event$target$selecte = event.target.selectedOptions[0].dataset,
                field = _event$target$selecte.field,
                order = _event$target$selecte.order;

            if (field == null) {
                // == for null or undefined
                var idList = this.state.displayData.data.map(function (item) {
                    return item.id;
                });
                // reset sort order to default/featured but retain filtered values
                var resetValues = this.state.apiData.data.filter(function (item) {
        ...
        value: function filterData(event) {
            ...
            var _state = this.state,
                ...
                lastSort = _state.lastSort,
                lastOrder = _state.lastOrder;

            var filteredData = apiData.data.filter(function (item) {
                return item[name] === value ? true : false;
            }).sort( // restore previous sort order
            (0, _constants.objComparer)(lastSort)(lastOrder));
            var newDisplayData = Object.assign({}, { data: filteredData });
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: _app2.default.center },
                    _react2.default.createElement(_sort2.default, { onUpdate: this.sortData }),
                    displayData.data.map(function (person) {
                        return _react2.default.createElement(_person2.default, { key: person.id, info: person });
                    })
                )
            );
        }
...
var _person = __webpack_require__(39);
...
var Person = function Person(props) {
    var _props$info = props.info,
        ...
        age = _props$info.age,
        category = _props$info.category,
        priority = _props$info.priority;


    return _react2.default.createElement(
        'div',
        { className: _person2.default.container, style: { backgroundColor: _constants.REF_priority[priority] } },
        _react2.default.createElement(
            'div',
            null,
            _react2.default.createElement(
                'h2',
                { className: _person2.default.name },
                name
            ),
            _react2.default.createElement(
                'div',
                { className: _person2.default.age },
                age
            ),
            _react2.default.createElement(
                'div',
                { className: _person2.default.category },
                category
            )
        )
    );
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./person.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./person.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".person__container___1qAn0 {\r\n    border: solid 2px black;\r\n    width: 238px;\r\n    padding-left: 4px;\r\n    margin: 4px;\r\n    float: left;\r\n}\r\n\r\nh2.person__name___1nfFY {\r\n    font-size: 16px;\r\n    font-weight: bold\r\n}\r\n\r\n.person__age___2Jsnp {\r\n    font-size: 12px;\r\n    font-style: italic;\r\n}\r\n\r\n.person__category___1-tFV {\r\n    font-size: 12px;\r\n    font-style: normal;\r\n}", ""]);

// exports
exports.locals = {
	"container": "person__container___1qAn0",
	"name": "person__name___1nfFY",
	"age": "person__age___2Jsnp",
	"category": "person__category___1-tFV"
};
...
var Filter = function Filter(props) {
    var uniqueCategories = [].concat(_toConsumableArray(new Set(props.categories))).sort();
    var wrapRadioBtn = function wrapRadioBtn(option) {
        return _react2.default.createElement(
            'div',
            { className: _filter2.default.radio, key: option },
            _react2.default.createElement('input', { type: 'radio', name: 'category', onClick: props.onUpdate, value: option }),
            ' ',
            option
        );
    };
    ...
    return _react2.default.createElement(
        'div',
        { className: _filter2.default.container },
        _react2.default.createElement(
            'h4',
            null,
            'Filter'
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./filter.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./filter.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".filter__container___3DZwf {\r\n    margin: 14px 0px;\r\n}\r\n\r\n.filter__radio___2_Jps {\r\n    padding: 3px;\r\n    font-size: 16px;\r\n}\r\n\r\n.filter__button___2IzMf {\r\n    margin: 4px;\r\n}", ""]);

// exports
exports.locals = {
	"container": "filter__container___3DZwf",
	"radio": "filter__radio___2_Jps",
	"button": "filter__button___2IzMf"
};
...
var Sort = function Sort(props) {
    return _react2.default.createElement(
        'div',
        { className: _sort2.default.container },
        _react2.default.createElement(
            'span',
            null,
            'Sort By: '
        ...
        _react2.default.createElement(
            ...
            _constants.REF_sortConfig.map(function (config) {
                return _react2.default.createElement(
                    'option',
                    { key: config.id, 'data-field': config.field, 'data-order': config.order, value: config.display },
                    config.display
                );
            })
        )
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./sort.css", function() {
			var newContent = require("!!../../node_modules/css-loader/index.js?modules&importLoaders=1&localIdentName=[name]__[local]___[hash:base64:5]!./sort.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".sort__container___3aZdi {\r\n    margin: 4px;\r\n    text-align: right\r\n}", ""]);

// exports
exports.locals = {
	"container": "sort__container___3aZdi"
};
